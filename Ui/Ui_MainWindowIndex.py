...
class Ui_Index(object):
    def setupUi(self, Index):
        ...
        self.pushButtonProductEdit = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonProductEdit.setObjectName("pushButtonProductEdit")
        self.verticalLayout.addWidget(self.pushButtonProductEdit)
        ...
        self.pushButton_MemberRegister = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_MemberRegister.setObjectName("pushButton_MemberRegister")
        self.verticalLayout_2.addWidget(self.pushButton_MemberRegister)
    ...
    def retranslateUi(self, Index):
        ...
        self.pushButtonProductEdit.setText(_translate("Index", "项目设置"))
        self.pushButton_3.setText(_translate("Index", "卡-项目折扣"))
        self.pushButton_4.setText(_translate("Index", "发行新卡"))
        self.pushButton_MemberRegister.setText(_translate("Index", "会员注册"))
